  ...
  <div class="yay-smtp-card-body">
	...
	<div class="setting-el">
	  ...
	  <div class="setting-field">
		...
		<label class="radio-setting">
		  <input type="radio" data-setting="region" id="yay_smtp_setting_sparkpost_region_eu" name="yay_smtp_setting_sparkpost_region" class="yay-settings" value="EU" <?php echo 'EU' === $region ? 'checked' : ''; ?>>
		  EU
		</label>
	  </div>
	</div>

...
<div class="yay-smtp-card yay-smtp-mailer-settings" data-mailer="<?php echo esc_attr( $mailer ); ?>" style="display: <?php echo $currentMailer == $mailer ? 'block' : 'none'; ?>">
  ...
  <div class="yay-smtp-card-body">
	...
	<div class="setting-el">
	  ...
	  <div class="setting-field">
		<input type="text" data-setting="domain" id="yay_smtp_setting_mailgun_domain" class="yay-settings" value="<?php echo esc_attr( $domainV ); ?>">
		<p class="setting-description">
		  Click here to
	...
	<div class="setting-el">
	  ...
	  <div class="setting-field">
		<label class="radio-setting">
		  <input type="radio" data-setting="region" id="yay_smtp_setting_mailgun_region_us" name="yay_smtp_setting_mailgun_region" class="yay-settings" value="US" <?php echo 'US' === $region ? 'checked' : ''; ?>>
		  US
		</label>
		<label class="radio-setting">
		  <input type="radio" data-setting="region" id="yay_smtp_setting_mailgun_region_eu" name="yay_smtp_setting_mailgun_region" class="yay-settings" value="EU" <?php echo 'EU' === $region ? 'checked' : ''; ?>>
		  EU
		</label>
	  </div>
	</div>

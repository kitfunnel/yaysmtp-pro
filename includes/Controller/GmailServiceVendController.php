...
class GmailServiceVendController {
	...
	private function saveAccessTokenWithCode( $googleClient ) {
		$gmail_auth_code = $this->getSetting( 'gmail_auth_code' );
		if ( ! empty( $gmail_auth_code ) && $this->tokenEmpty() ) {
